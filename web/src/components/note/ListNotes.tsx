...
export default function ListNotes() {
  ...
  const onChangeTitleHandler = (evt: React.ChangeEvent<HTMLInputElement>) => {
    setNoteForm({
      ...noteForm,
  ...
  return (
    <Fragment>
          ...
          {data?.listNotes.map((note) => (
            ...
            >
              <div className="note-detail">
                ...
                <small>{dayjs(note.updated_at).fromNow()}</small>
              </div>
              <div
      ...
      <EditorContainer disabled={!selectedNote}>
        {/* <div>
          <button onClick={onUpdateNoteHandler}>Save</button>
        </div> */}
        <input
